...
const cards = () => {
  return (
    ...
    <div class="flex-item-start" style={{maxWidth:"400px",height:"14rem", padding:"20px"}}>
  <div class="card-header"><img src={blue1} alt="cloud" style={{color:"blue"}}/></div>
  <div class="card-body">
    <h6 class="card-title">Better Coverage</h6>
    <small class="card-text" style={{fontWeight:300,fontSize:"13px"}}>Some quick example text to build on the card title and make up the bulk of the card's content.</small>
  </div>
</div>
<div class="flex-item-middle" style={{maxWidth:"400px",height:"14rem" , padding:"20px"}}>
...
<div class="flex-item-end" style={{maxWidth:"400px",height:"14rem" , padding:"20px"}}>
