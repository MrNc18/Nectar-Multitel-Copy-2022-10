...
import { getAllCorCategories,getAddCorCategories,getEditCorCategories,getDeleteCorCategories } from "../../../services/Phase_2/WhoWeR";

export const CorporateCat = () => {
  ...
  const handleDeleteData = async() => {
    ...
    try {
      await getDeleteCorCategories(data);
      showAlert( " Corporate Category Deleted Successfully","success");
      setDeleteShow(false);
      handleAllData();
    } catch (error) {
  ...
  const handleSubmit = async(e) => {
    ...
    if (
      ...
      try {
        ...
        await getAddCorCategories(data);
  ...
  const handleEditData = async() => { 
    ...
    try {
      await getEditCorCategories(data);
    ...
    <div id="layoutSidenavContent">
      <div className="container-fluid">
        <div class="row d-flex align-items-center justify-content-between">
          ...
          >
            <h3 className="mt-4 mb-4">Corporate Bodies</h3>
            <div
            ...
            >
              <button
                ...
                onClick={handleShow}
              >
                <i className="fas fa-plus-circle"></i> Add Corporate Category
              </button>
