                ...
                <Row>
                  ...
                  <Col md={8} lg={7}>
                    <div className="telephony_right">
                      ...
                      <p className="white-text">{phoneDetails?.description}</p>
          ...
          <Container>
            <Row>
              <Col md={5}>
                ...
                <p className="fw-500">There are vaious types of Movie Pack Plans.</p>
                <div className="plan_buttons mt-4">
                  <Button 
                  variant="primary primary_bg"
                  onClick={() =>
                    navigate(
                      "/categories/internet-services/tv-services"
                    )
                  }
                  >See Plans</Button>
                </div>
              ...
              <Col md={7}>
                <img className="tv_img" src={`${baseurl}/images/${tvDetails?.image}`} />
              </Col>
            </Row>
          </Container>
        )}
