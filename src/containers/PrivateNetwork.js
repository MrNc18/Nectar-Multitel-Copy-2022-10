          ...
          <Row>
            <Col md={12}>
              ...
              >
                ...
                <Breadcrumb.Item active style={{ color:"#0076B5" }}>Private Networks</Breadcrumb.Item>
              </Breadcrumb>
              </div>
            </Col>
          </Row>
              ...
              <Col md={3} className="sidenav mb-3" style={{ backgroundColor: "#E2E2E2"}}>
                ...
                >
                  ...
                  <Nav.Item>
                    ...
                    <i class="fa-solid fa-headphones"></i>&nbsp;&nbsp; Secured Access
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="satdate">
                    <i class="fa-solid fa-chart-line"></i>&nbsp;&nbsp; Sat Date
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="lantolan">
                    <i class="fa-solid fa-sd-card"></i>&nbsp;&nbsp; Lan-To-Lan
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
